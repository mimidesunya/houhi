...
債務者は、インターネット上の〇〇サービスを運営し、同サービス上の投稿記事を管理する権限を有する者である。
...
本件投稿の削除は、債務者又は債務者から権限を与えられた者でなければ行うことができない。

したがって、債権者は、債務者に対し、人格権に基づく妨害排除請求権として、本件投稿の削除を求める権利を有する。

## 4 保全の必要性

本件投稿は、現在も削除されることなくインターネット上で公開されており、債権者の人格権侵害が継続している。
本案判決の確定を待っていたのでは、被害が拡大し、回復困難な損害が生じるおそれがある。

したがって、債務者に対し、本件投稿を仮に削除させる必要がある。
...
本件投稿は、債権者の氏名、肩書、所属、経歴、周辺事情その他の記載から、債権者を指すものと理解できる。
